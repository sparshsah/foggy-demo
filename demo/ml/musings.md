...
* Prompt repetition ->
    - TODO(sparshsah): Does this enable a model with causal attention to imitate/approximate bidirectional attention?
* Prompt caching ->
...
But as time has gone on, I'm not so sure... I've found that OpenAI's ChatGPT or Anthropic's Claude is faster and better at debugging and recovering from system incidents than human engineers. After all, in my reckoning the human brain is just a highly-complicated computer (notwithstanding the Penrosian hypothesis that the brain is actually supermechanical or supercomputational, i.e. "consciousness" is beyond the capabilities of any---even quantum---computer), equally prone to panicking or overconfidence as the machine is prone to going haywire or hallucinating. That's to say nothing of bonafide mistakes, which---goes without saying---both can make, too.
...
I pick option 3:
One that's exactly perfect!
Just kidding :)
But I do have thoughts on
one "valid" consideration and
one "invalid" consideration here.
